			...
			<div class="panel panel-default">
				...
				<div class=" panel-body">
                  ...
                  <div class="form-group">
                        ...
                        <span class="text-muted" style="font-style: italic; font-size: 10px;">Please provide the number of the person who introduced you to Emmat Mall</span>
                          <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-phone"></i>+233</span>
      ...
      <div class="panel panel-default" id="paymentPanel">
        ...
        <div class="panel-body">
                   ...
                   <br>
                    ...
                    <div class="form-group">
                       <label>Amount sent <span style="color: red;">*</span></label>
                        <div class="input-group">
        ...
        <div class="panel-footer">
          <div class="form-group clearfix">
            <button type="submit" class="btn btn-info pull-right">Submit order</button>
          </div>
        </div>
      </div>
      </form>
